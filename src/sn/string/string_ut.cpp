...
TEST(string, ints) {
    ...
    EXPECT_ANY_THROW(sn::from_string<bool>("da"));
    EXPECT_ANY_THROW(sn::from_string<bool>(""));
    EXPECT_ANY_THROW(sn::from_string<int>(""));
    EXPECT_ANY_THROW(sn::from_string<int>(" 100"));
    EXPECT_ANY_THROW(sn::from_string<int>("100 "));
    EXPECT_ANY_THROW(sn::from_string<int>("+100"));
    EXPECT_ANY_THROW(sn::from_string<int>("0x200"));
    EXPECT_ANY_THROW(sn::from_string<int>("0b100"));
}
...
TEST(string, floats) {
    ...
    EXPECT_ANY_THROW(sn::from_string<float>(" 1.5"));
    EXPECT_ANY_THROW(sn::from_string<float>("1.5 "));
}
